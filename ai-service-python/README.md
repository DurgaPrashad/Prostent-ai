...
This service handles all AI-related functionality for the Prostent platform using the Google Gemini API and Murf Falcon TTS with graph visualization capabilities.
