      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Experience how Prostent transforms your experience with AI-powered voice intelligence
          </p>
        </div>
            ...
            <Card className="glass h-full">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  As a user, Prostent provides you with a seamless voice-first AI experience:
                </p>
        ...
        >
          <Card className="glass max-w-2xl mx-auto">
            <CardContent className="p-8">
              <h2 className="text-2xl font-bold mb-4">Ready to Experience Prostent?</h2>
